      ...
      <div className="resume modal-dialog" role="document">
        <div className="resume modal-content">
          ...
          <div className="modal-body">
            <img
              src="https://media.licdn.com/dms/image/C5603AQExZfKddm1r4w/profile-displayphoto-shrink_200_200/0?e=1554336000&v=beta&t=T1SejHWE05CtVyaUXfQ2luyr2ox5xNUUbUvQJpNcG9g"
              alt="Profile photo"
              id="resume-profile"
              className="img-fluid"
            />
            ...
            <div id="contact-info" className="vcard">
              ...
              <p>
                Cell: <span className="tel">555-666-7777</span>
                <br />
                Email:{" "}
                <a className="email" href="mailto:greatoldone@lovecraft.com">
                  greatoldone@lovecraft.com
                </a>
              </p>
            </div>
            ...
            <div id="objective">
              <p>
                ...
                seeking a career that fits my professional skills, personality,
                and murderous tendencies. My squid-like head is a masterful
                problem solver and inspires fear in who gaze upon it. I can
